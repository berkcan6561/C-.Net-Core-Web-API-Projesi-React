    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Yeni Şifre Belirle</h1>
          <p className="text-slate-500 mt-2">Lütfen hesabınız için yeni bir şifre belirleyin.</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8">
          ...
          {status === 'success' ? (
            <div className="text-center animate-fade-in">
              ...
              <h2 className="text-xl font-bold text-slate-800 mb-2">Başarılı!</h2>
